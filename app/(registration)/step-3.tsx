			...
			<View className="flex-1 bg-white-500">
				...
				<View className=" mt-4 gap-2 ">
					...
					<View className="flex gap-4 mt-4">
						...
						<Controller name="birthdate" control={control} render={({ field: { onChange, value } }) => {
							return <>

								<Input placeholder="Birthdate (MM-DD-YYYY)" id="birthdate" value={value} error={errors.birthdate} onPress={showDatePicker} />
